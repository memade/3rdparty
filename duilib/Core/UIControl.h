...
namespace DuiLib {
 ...
 public:
  ...
  virtual INT64 GetTagINT64() const; // 辅助函数，供用户使用
  virtual void SetTagINT64(INT64 pTag); // 辅助函数，供用户使用
  virtual UINT64 GetTagUINT64() const; // 辅助函数，供用户使用
  virtual void SetTagUINT64(UINT64 pTag); // 辅助函数，供用户使用
  virtual void SetCache(const std::string& cache); // 辅助函数，供用户使用
  virtual const std::string& GetCache() const;
